...
export function getTreeDeptSelect() {
  return request({
    url: orgMock + '/dept/treePostAndDeptselect',
    method: 'get'
  })
}
// 查询部门基本信息
export function getBaseDeptInfo(userId) {
  return request({
    url: orgMock + '/dept/getDept/' + userId,
    method: 'get'
  })
}
// 查询岗位基本信息
export function getBaseJobInfo(userId) {
  return request({
    url: orgMock + '/businessPost/getPost/' + userId,
    method: 'get'
  })
}
// 编辑岗位信息
