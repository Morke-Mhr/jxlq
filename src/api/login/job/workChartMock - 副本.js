...
export function getAddWorkchart(data) {
  return request({
    url: orgMock + '/workProcess/addWorkProcess',
    method: 'post',
    data
  })
}
...
export function getWorkchartList({pageNum, pageSize,name,status,createBy,createByTime}) {
  return request({
    url: orgMock + `/workProcess/list?pageNum=${pageNum}&pageSize=${pageSize}&name=${name}&status=${status}&createBy=${createBy}&createByTime=${createByTime}`,
...
export function getDelWorkchart(wProcessId) {
  return request({
    url: orgMock + '/workProcess/delete/'+wProcessId,
    method: 'delete'
  })
}
// 查看工作流程
...
export function getlookWorkchart(wProcessId) {
  return request({
    url: orgMock + '/workProcess/getWorkProcess/'+wProcessId,
    method: 'get'
  })
}
// 提交工作流程
export function getSubmitWorkchart(wProcessId) {
  return request({
    url: orgMock + '/workProcess/submit/'+wProcessId,
    method: 'put'
  })
}
// 编辑工作流程
...
export function getSetJob(data) {
  return request({
    url: orgMock + '/wprocessPost/setPost',
    method: 'post',
    data
  })
}
...
export function getNodeIdJob(nodeId) {
  return request({
    url: orgMock + '/wprocessPost/getWpPost/'+nodeId,
    method: 'get'
  })
}
// 点击节点获得关联作业指导书
...
export function getNodeIdBook(nodeId) {
  return request({
    url: orgMock + '/wprocessGuide/getWpGuide/'+nodeId,
    method: 'get'
  })
}
//新增作业指导书
export function getAddWorkBookList() {
  return request({
    url: addWorkMockService + '/workstandardDoc',
    method: 'get',
  })
}
//删除作业指导书
export function getDeleteWorkBook(wprocessGuideId) {
  return request({
    url: orgMock + '/wprocessGuide/delete/'+wprocessGuideId,
    method: 'delete',
  })
}
//列表下载作业指导书附件
export function getDowloadWork({name, path}) {
  return request({
    url: orgMock + `/fs/download?name=${name}&path=${path}`,
    method: 'get',
  })
}
//保存新增作业指导书
export function getSaveAddWork(data) {
  return request({
    url: orgMock + '/wprocessGuide/setGuide',
    method: 'post',
    data
  })
}
