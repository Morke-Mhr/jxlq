<template>
  <div class="app-container job-change" style="background: #ffffff">
    ...
    <el-form
      ...
      class="change-form"
    >
      <el-form-item prop="beforeDept" label="调出部门" style="width: 50%">
        <el-input
      ...
      <el-form-item prop="beforePost" label="调出岗位" style="width: 50%">
        <el-input
    ...
    > -->
      ...
      <el-form-item prop="toUser" label="审批人" style="width: 50%">
        <el-input
  ...
  methods: {
    ...
    submitFun(formName) {
      this.$refs[formName].validate(async (valid) => {
        ...
        try {
          data = await getAddJobChange(jobData);
        } catch (e) {
          console.error("接口异常");
        }
        this.$notify({
