    ...
    <div class="container-table safety-plan">
        <div class="table-list confide-content">
            ...
            >
                ...
                >
                    <el-radio-group v-model="addPlan.pxWay" @change="wayChange">
                        ...
                        <el-radio :label="true">线下</el-radio>
                    </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="关联考试名称" style="width: 90%; float: left">
                    <el-input
            ...
            trigger: ['change', 'blur']
                ...
                >
                    <el-select
                        v-model="addPlan.trainCoursewareList[0].traincoursewareId"
                        placeholder="请选择主题"
                        style="width: 100%"
            ...
            <!-- <div style="text-align: right">
              ...
              <el-button class="cancel-btn" @click="closeFun"> 取消 </el-button>
            </div> -->
          ...
          <el-button @click="dialogVisibleExam = false">取 消</el-button>
          <el-button type="primary" @click="dialogVisibleExam = false"
          >确 定</el-button
          >
        </span>
            </el-dialog>
            ...
            <div class="sdialog">
                ...
                >
                    ...
                    <div style="text-align: right">
                        <el-button type="primary" class="tBtn" @click="selectDept">
                            提交
                        </el-button>
            ...
            <div class="sdialog">
                ...
                >
                    ...
                    <div style="text-align: right">
                        <el-button type="primary" class="tBtn" @click="selectDeptSp">
                            提交
                        </el-button>
                        <el-button class="fBtn" @click="dialogVisibleDeptSp = false">
                            取消
                        </el-button>
                    </div>
                </el-dialog>
...
import {
    getAddPlan,
    getTrainBook,
    trainPlan as trainPlanFun
} from '@/api/safety/plan.js'
import {getChangeJobNextNode, viewBusinessInfo} from '@/api/system/process'
import publicExamPlan from '@/views/safetyEdu/plan/publicExamPlan'
...
export default {
    ...
    methods: {
        ...
        async getAllList() {
            ...
            this.addPlan = res.body;
            if(this.addPlan.trainCoursewareList == null) {
                this.addPlan.trainCoursewareList = [{
                    traincoursewareId: ''
                }];
            }

            if(this.addPlan.trainplanFileList == null ){
                this.addPlan.trainplanFileList = [];
            }
        },
        //获取列表
        chooseList() {
        ...
        async addSelBook(val) {
            ...
            console.log(this.addPlan.trainCoursewareList)
        },
        ...
        async alertChoose() {
            ...
            this.deptOptionsArr = await getTreeSelect()
        ...
        async confirm() {
            this.addPlan.businessCode = this.businessCode
            if (this.addPlan.isApply == true) {
                this.$refs.nextDataFormRules.validate(async (valid) => {
                    ...
                    if (this.addPlan.trainPersonList.length == 0) {
                        ...
                        let needData = {
                            trainplanId: this.addPlan.trainplanId,
                            ...
                            relationExamId: this.addPlan.relationExamId,
                            relationExamName: this.addPlan.relationExamName,
                            isApply: this.addPlan.isApply,
                            toUser: this.addPlan.toUser,
                            businessCode: this.addPlan.businessCode,
                            taskNumer: this.scopeRow.taskId,
                            trainCoursewareList: [
                                {
                                    traincoursewareId: this.addPlan.trainCoursewareList[0]
                                        .traincoursewareId
                                }
                            ],
                            trainPersonList: this.addPlan.trainPersonList
                        }
                        data = await trainPlanFun(needData)
