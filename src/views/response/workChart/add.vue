                    ...
                    <el-col :span="5">
                        <section class="right-part">
                            <div id="detailpannel">
                                ...
                                <div id="basicForm" class="pannel" data-status="canvas-selected" v-show="propetyPanel">
                                    ...
                                    <div class="main">
                                        <el-form label-width="100px" label-position="right">
                                            <el-form-item label="网格对齐">
                                                <el-checkbox v-model="basicForm.grid"
                                                             @change="toggleGridShowStatus"></el-checkbox>
                                            </el-form-item>
                                            <el-form-item label="流程图名称">
                                                <el-input v-model="basicForm.name" @change="saveNodeAttribute"
                                                          style="width: 80%;"></el-input>
                                            </el-form-item>
                                            <el-form-item label="描述">
                                                <el-input v-model="basicForm.description" @change="saveNodeAttribute"
                                                          style="width: 80%;"></el-input>
                                            </el-form-item>
                                        </el-form>
                                    </div>
...
import {getAddWorkchart, getlookWorkchart} from '@/api/job/workChart'
...
export default {
    ...
    methods: {
        ...
        async save(source) {
            ...
            let res = await getAddWorkchart(this.formList)
            this.$notify({
                title: res ? '操作成功' : '操作失败',
...
.openSidebar #vue-g6-editor {
    left: 220px;
}

.add-editor #vue-g6-editor {
    position: fixed;
    top: 215px;
    left: 8.7%;
    right: 35px;
