...
import {
  ...
  getNoticesPage,
  getPieSafeCheckStatDataMider,
  getBarSafeCheckStatDataMider,
  getPieYhRectStatDataMider,
  getBarYhRectStatDataMider,
  getPieSafeBookStatDataMider,
  getBarSafeBookStatDataMider,
  noticeView,
...
export default {
  ...
  methods: {
    async TodoCenter() {
       ...
       * */
      //饼状图
      let dutyB = await getPieSafeBookStatDataMider();
      ...
      //柱状图
      let dutyZ = await getBarSafeBookStatDataMider();
       ...
       * */
      //饼状图
      let statisticsB = await getPieSafeCheckStatDataMider();
      ...
      //柱状图
      let statisticsZ = await getBarSafeCheckStatDataMider();
       ...
       * */
      //饼状图
      let hiddenB = await getPieYhRectStatDataMider();
      ...
      //柱状图
      let hiddenZ = await getBarYhRectStatDataMider();
